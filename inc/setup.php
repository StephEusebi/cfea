...
if ( ! function_exists( 'stepheusebi_setup' ) ) :
	...
	function stepheusebi_setup() {
		 ...
		 * If you're building a theme based on cfea theme, use a find and replace
		 * to change 'cfea-theme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'cfea-theme', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'cfea-theme' ),
		) );
...
function stepheusebi_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'cfea-theme' ),
