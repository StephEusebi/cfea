...
?>
	...
	<div id="primary" class="content-area">
		...
		<!-- <header class="header1">
			...
			<p class="cell large-12 progDesc">The disparity between movement and power exercises is linked by ViPR. 
			...
			<p class="cell large-12 progDesc">Loaded Movement Training blends movements that are adapted for resilient 
			...
			<p class="cell large-12 progDesc">ViPR was stimulated by farm youngsters who moved with weights on a daily 
			...
			<p class="cell large-12 progDesc">As Michol Dalcourt, the creator of ViPR clarifies; the art of movement 
			...
			<table class="programTables">
				...
				<tr>
					<td>ViPR</td>
					<td>Loaded Movement Training</td>
					<td>$225.00 plus tax</td>
				</tr>
			</table>
